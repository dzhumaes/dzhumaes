...
r = requests.post(url, json={"command":"executeScript","docHandle": docHandle,"scriptCode": "dsmDaysScript", 'sessId': ''})
print('Сценарий выполнен успешно') if r.status_code == 200 else sys.exit(0)
print(r)